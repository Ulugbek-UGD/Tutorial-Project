...
{
    /// <summary>
    /// A custom inspector for <see cref="InputActionsRebinding"/> which provides a more convenient way for
    /// picking the binding which to rebind.
    /// </summary>
    [CustomEditor(typeof(InputActionsRebinding))]
    public class InputActionsRebindingEditor : Editor
    {
        private SerializedProperty m_CancelWithProperty;
        ...
        private readonly GUIContent m_SettingsLabel = new("Settings");
        ...
        {
            m_CancelWithProperty = serializedObject.FindProperty("m_CancelWith");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Settings section.
            EditorGUILayout.LabelField(m_SettingsLabel, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_CancelWithProperty);
            }
